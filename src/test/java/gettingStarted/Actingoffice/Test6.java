...
public class Test6 {
    ...
    public static void test() {
        ...
        test = extent.createTest("Create Credit note with part payment Test");
        ...
        invoiceNo.click();
            test.pass(" invoice number selected");
        WebElement saveBtn = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("//button[.//span[text()='Save']]")
        ));
        saveBtn.click();
            test.pass(" save clicked");
