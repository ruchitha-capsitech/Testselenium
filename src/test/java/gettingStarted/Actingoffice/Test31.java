...
public class Test31 {
    ...
    public static void test() {
        ...
        test = extent.createTest("Customer statement of accounts Test");
        try {
        ...
        elementCustomerId.click();
            test.pass("CustomerId button clicked  successfully");
        ...
        elementFrom.sendKeys("03/01/2023");
            test.pass("From date  successfully");
        ...
        elementTo.sendKeys("30/11/2025");
            test.pass("To date updated  successfully");
        ...
        elementReportsButton.click();
            test.pass("Reports button clicked  successfully");
        ...
        elementCustomerBalance.click();
            test.pass("CustomerBalance button clicked  successfully");
        ...
        elementCustomer.click();
            test.pass("Customer button clicked  successfully");
