...
public class Test11 {
    ...
    public static void test() {
        ...
        test = extent.createTest("Increase qty in credit as in actual invoice Test");
        try {
        ...
        elementCreditNotesButton.click();
            test.pass("Credit notes clicked successfully");
        ...
        elementAddCreditNote.click();
            test.pass("add Credit notes clicked successfully");
        ...
        InvoiceRefNo.click();
            test.pass("InvoiceRefNo clicked successfully");
        ...
        invoiceNo.click();
            test.pass("invoiceNo clicked successfully");
        ...
        Quantity.sendKeys("2");
            test.pass("quantity increased  successfully");
            String path = "screenshots/test11.1.png";
