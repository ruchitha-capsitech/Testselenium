...
public class Test12 {
    ...
    public static void test() {
        ...
        test = extent.createTest("Increase discount in credit note as in invoice Test");
        try {
        ...
        Discount.sendKeys("10");
            test.pass("Discount increased  successfully");
            ...
            WebElement accountDropdown = wait.until(ExpectedConditions.elementToBeClickable(
                    By.xpath("//*[@id=\"ModalFocusTrapZone1544\"]/div[2]/div/div[2]/form/div/div[2]/table/tbody/tr/td[2]/div/div/div/div[1]/div[2]")
            ));
