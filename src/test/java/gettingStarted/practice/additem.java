...
public class additem {
    public static void main(String [] args) throws InterruptedException {
        ...
        By Items = By.name("Items");
        WebElement elementItems = wait.until(ExpectedConditions.elementToBeClickable(Items));
        elementItems.click();

        By addItems = By.name("Item");
        WebElement elementaddItems = wait.until(ExpectedConditions.elementToBeClickable(addItems));
