...
public class addcustomer {
    public static void main(String [] args) throws InterruptedException {
        ...
        By Customers = By.name("Customers");
        WebElement elementCustomers = wait.until(ExpectedConditions.elementToBeClickable(Customers));
        elementCustomers.click();

        By addCustomers = By.name("Customer");
        WebElement elementaddCustomers = wait.until(ExpectedConditions.elementToBeClickable(addCustomers));
