...
public class addpayments {
    public static void main(String [] args) throws InterruptedException {
        ...
        By Payments = By.name("Payments");
        WebElement elementPayments = wait.until(ExpectedConditions.elementToBeClickable(Payments));
        elementPayments.click();

        By addPayment = By.name("Payment");
        WebElement elementPayment = wait.until(ExpectedConditions.elementToBeClickable(addPayment));
